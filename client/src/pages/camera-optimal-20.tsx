...
export default function CameraOptimal20() {
  ...
  // Take all 20 photos in sequence for 5×4 rectangular grid
  const captureAllPhotos = () => {
    ...
    const captureSequence = () => {
      ...
      if (photoData) {
        ...
        if (photoCount < 20) {
          setTimeout(captureSequence, 200); // 5 fps for faster capture
        }
      }
    };
  ...
  // Create 5×4 rectangular grid collage from 20 photos
  const createRectangularCollage = useCallback((photos: CapturedPhoto[]) => {
    ...
    firstImg.onload = () => {
      ...
      // Create canvas with 5×4 grid layout, maintaining viewport aspect ratio for each rectangle
      const cols = 5;
      const rows = 4;
      
      // Calculate rectangle dimensions based on actual viewport aspect ratio
      const baseSize = 240; // Smaller base size for 20 photos
      ...
      photos.forEach((photo, index) => {
        ...
        img.onload = () => {
          ...
          // Divide the original image into 5×4 grid and take the corresponding section
    ...
    >
      ...
      {!isCapturing && !finalCollage && (
        <div className="flex flex-col items-center justify-center min-h-screen p-8">
          <h1 className="text-4xl font-bold mb-8 text-center">20-Photo Ultra-Detailed Collage</h1>
          <p className="text-xl mb-8 text-center max-w-2xl">
            Advanced tessellation system capturing 20 photos in a 5×4 grid at 5fps. Each photo contributes one precise rectangle for ultra-detailed composite imagery with perfect aspect ratio preservation.
          </p>
      ...
      {showViewfinder && (
        <div className="absolute inset-0 z-10">
          {/* Grid overlay showing 5×4 layout */}
      ...
      {finalCollage && (
        <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-8">
          <h1 className="text-4xl font-bold mb-8 text-center">20-Photo Ultra-Detailed Collage Complete!</h1>
          
          <div className="mb-8 max-w-4xl">
            <img 
              src={finalCollage} 
              alt="20-photo rectangular collage"
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-center">
            <div className="flex gap-4">
              <a
                href={finalCollage}
                download="ultra-detailed-collage-20.jpg"
